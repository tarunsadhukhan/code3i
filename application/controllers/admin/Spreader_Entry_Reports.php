...
class Spreader_Entry_Reports extends CI_Controller {
	...
	//	$data['records'] = $this->Doffdata_Model->get_all_records();
     //   $this->load->view('record_form', $data);
        ...
        $this->load->model('Spreaderentryreports');
        
//        $categories=$this->Doffdata_Model->getCategories();
//		$data['categories']=$categories;
$wndmcdata=$this->Spreaderentryreports->getwndmcnodata();
 echo $wndmcdata;

		$data['wndmcdata']=$wndmcdata;
	
		
		$this->load->view('admin/spreader/spreader_production_entry');
