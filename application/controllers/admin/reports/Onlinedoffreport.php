...
class Onlinedoffreport extends CI_Controller {
...
//		$data['categories']=$categories;
		...
		$this->load->view('admin/doffdata/Onlinedoffreport');
  ...
  $response = array(
   ...
   // echo 'frame--'.$frameNo;
    ...
    //    $records = $this->Doffdata_Model->get_records($date, $shift,$compid);
		...
		$sql = "SELECT auto_id, DATE_FORMAT(doffdate, '%d-%m-%Y') doffdate, spell, frameno, trollyno, grosswt, 
		tarewt, netwt ,entrytime,entry_mode
            FROM dofftable 
