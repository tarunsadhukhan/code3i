  ...
  <div class="content-wrapper">
      ...
      <div class="content-header">
          <div class="container-fluid">
              <div class="row mb-2">
                  <div class="col-sm-12">
                      <h3 class="m-1 text-dark text-center" style="background-color: #1589FF;"><strong>Daily Wastage Entry</strong></h3>
                  ...
                  <form name="categoryForm" id="categoryForm" method="" action="">
                      ...
                      <div class="form-row">
                          ...
                          <div class="form-group col-md-1" style="margin-left: 10px;">
                              <label for="purchaseDetailsPurchaseDate">Show Data<span class="text-center"></span></label>
                              <button name="submit" id="searchdata" style="height: 50px;" type="submit" class="form-control btn btn-primary">Show</button>
                          </div>

                          <div class="form-group col-md-1" style="margin-left: 10px;">
                              <label for="purchaseDetailsPurchaseDate">Save Data<span class="text-center"></span></label>
                              <button name="submit" id="printdata" style="height: 50px;" type="submit" class="form-control btn btn-primary">Print</button>
                          </div>
      ...
      function initDataTable() {
        ...
        //   alert(deptid);    
          ...
          table = $('#recordTable').DataTable({
              ajax: {
                  url: '<?php echo base_url('admin/reports/Daily_layout_print/getebmcdata'); ?>',
                  type: 'POST',
                  data: function(d) {
...
//          refreshDataTable();
      ...
      $("#printdata").click(function(event) {
          event.preventDefault();
          //      alert('aabb');
          ...
          var deptid = $('#mc_no1').val();
          var url = '<?php echo site_url("admin/reports/Daily_layout_print/exportdbfdata"); ?>' +
          ...
          return false;
            ...
            $('#printdata1').click(function() {
                $.ajax({
                    url: "<?php echo site_url('admin/reports/Daily_layout_print/printebmcdata'); ?>",
                    type: "POST",
                    dataType: "json",
                    success: function(response) {
                        if (response.download_link) {
                            $('#downloadLinkContainer').html(
                                '<a href="' + response.download_link + '" download>Download Modified Excel File</a>'
                            );
                        } else {
