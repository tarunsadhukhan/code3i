  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-10">
          <h3 class="m-1 text-dark text-center" style="background-color: #1589FF;">Loom Data Report</h3>
          </div><!-- /.col -->
          <div class="col-sm-2">
    ...
    <input type="hidden" class="input" value="<?php echo $company_id; ?>" id="companyId" />
      ...
      <div class="form-group col-md-2">
						  ...
						  <input type="text" style="height: 50px; color:blue; font-style: bold; font-size: 28px;"
               class="form-control datepicker text-center" id="doffrepdateto" 
              name="doffrepdateto"   readonly >
			</div>
            ...
            <div class="form-group col-md-2" style="margin-left: 20px;">
  	  		  <label for="purchaseDetailsPurchaseDate">Export for Hours/Prod<span class="text-center"></span></label>
            <button name="submit" id="loomvowhrsprodexp" style="height: 50px;" type="submit" class="form-control btn btn-primary">Export</button>
            </div>
            <div class="form-group col-md-2" style="margin-left: 20px;">
  	  		  <label for="purchaseDetailsPurchaseDate">Upload for Hours/ProdExport to Xl<span class="text-center"></span></label>
            <button name="submit" id="loomvowhrsprodupd" style="height: 50px;" type="submit" class="form-control btn btn-primary">Upload</button>
            </div>
...
$("#doffrepdate").datepicker({ 
  dateFormat: 'dd-mm-yy',
                ...
                $('#doffrepdate').datepicker('setDate', 'today');

$("#doffrepdateto").datepicker({ 
  dateFormat: 'dd-mm-yy',
					todayHighlight:'TRUE',
					autoclose: true,
                });
 
                $('#doffrepdateto').datepicker('setDate', 'today');
...
//	alert ("aaaa");
	var opt=3;
            ...
            var doffrepdateto= $('#doffrepdateto').val();
            
            var companyId=$('#companyId').val();
            var url = '<?php echo site_url("admin/Doffdata/loomdataexportToExcel"); ?>' +
                      '?doffrepdate=' + doffrepdate +
                       '&companyId=' + companyId + '&doffrepdateto=' + doffrepdateto  
                         ;
                      alert(url);
