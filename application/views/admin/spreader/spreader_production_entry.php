  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-10">
          <h3 class="m-1 text-dark text-center" style="background-color: #1589FF;">Daily Spreader Production Entry </h3>
          </div><!-- /.col -->
          <div class="col-sm-2">
    ...
    <input type="hidden" class="input" value="<?php echo $company_id; ?>" id="companyId" />
        ...
        <div class="form-group col-md-2" style="margin-left: 20px;" >
							<label for="purchaseDetailsVendorName">Spreader Mc No<span class="requiredIcon text-center">*</span></label>
