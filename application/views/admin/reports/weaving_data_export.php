  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-10">
          <h3 class="m-1 text-dark text-center" style="background-color: #1589FF;">Weaving Data Export</h3>
    ...
    <div class="content">
      ...
      <div class="form-row">
            ...
            <div class="form-group col-md-2" style="margin-left: 20px;">
			  <label for="purchaseDetailsPurchaseDate">Check List<span class="text-center"></span></label>
              <button name="submit" id="dofmodupdatebtn" style="height: 50px;" type="submit" class="form-control btn btn-primary">Check List</button>
            </div>
            <div class="form-group col-md-2" style="margin-left: 20px;">
			  <label for="purchaseDetailsPurchaseDate">Download Hours/Prod Data<span class="text-center"></span></label>
              <button name="submit" id="dofmodupdatebtn" style="height: 50px;" type="submit" class="form-control btn btn-primary">Download</button>
            </div>
            <div class="form-group col-md-2" style="margin-left: 20px;">
			  <label for="purchaseDetailsPurchaseDate">Upload Hours/Prod Data<span class="text-center"></span></label>
              <button name="submit" id="dofmodupdatebtn" style="height: 50px;" type="submit" class="form-control btn btn-primary">Upload</button>
            </div>
...
*/
      ...
      function initDataTable() {
            table = $('#dofmodexprecordTable').DataTable({
                ...
                ajax: {
                    url: '<?php echo base_url('admin/reports/weaving_data_export/loomchecklist'); ?>',
                    type: 'POST',
                    data: function(d) {
...
$("#exportdbfdata").click(function(event){
  event.preventDefault(); 
	...
	var opt=3;
            ...
            var url = '<?php echo site_url("admin/reports/weaving_data_export/exportdbfdata"); ?>' +
