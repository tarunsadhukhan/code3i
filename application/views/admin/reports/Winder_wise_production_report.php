  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
          <h3 class="m-1 text-dark text-center" style="background-color: #1589FF;"><strong>Winder Wise Production  Report</strong></h3>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    ...
    <div class="content">
      ...
      <div class="form-row">
                        ...
                        <div class="form-group col-md-2"  style="margin-left: 20px;">
                            <label for="purchaseDetailsVendorName">Emp Code<span class="requiredIcon text-center">*</span></label>
                            <input type="text" id="empcode" style="height: 40px; color:blue; font-style: bold; font-size: 18px;"  
                            name="empcode"  class="form-control   text-center">
                        </div>
...
<input type="hidden" class="input" value="<?php echo $company_id; ?>" id="companyId" />
            ...
            <h1>Winder's Production Report</h1>
      ...
      function initDataTable() {
           ...
           $('#qcrecordTable').DataTable().destroy();
            ...
            table = $('#qcrecordTable').DataTable({
                ajax: {
                    url: '<?php echo base_url('admin/reports/Winder_wise_production_report/get_wndindreprecords'); ?>',
                    type: 'POST',
                    data: function(d) {
