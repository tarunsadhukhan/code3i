  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
          <h3 class="m-1 text-dark text-center" style="background-color: #1589FF;"><strong>Daily Loom Report</strong></h3>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    ...
    <div class="content">
      ...
      <div class="form-row">
            ...
            <div class="form-group col-md-3"  style="margin-left: 50px;">
              ...
              echo "<option value='41' > Hessian</option>";
              echo "<option value='42' > Sacking</option>";
...
<input type="hidden" class="input" value="<?php echo $company_id; ?>" id="companyId" />
            ...
            <h1>Daily Loom Report</h1>
    <table id="qcrecordTable">
        <thead>
                    <tr>
            <th rowspan="2">Loom Type</th>
            <th rowspan="2">Loom No</th>

            <th style="text-align:center;" colspan="3">Shift A</th>
            <th style="text-align:center;" colspan="3">Shift B</th>
            <th style="text-align:center;" colspan="3">Shift C</th>
            <th style="text-align:center;" colspan="3">Overall</th>
        </tr>

<!-- <td align=center  size='24' font color='#FFFF00' >" . "Loom Type". "&nbsp;" . "</td>\n</font>
<td align=center  size='24' font color='#FFFF00' >" . "Loom No ". "&nbsp;" . "</td>\n</font>
<td align=center  size='24' font color='#FFFF00' >" . "Prod ". "&nbsp;" . "</td>\n</font>
    <td align=center  size='24' font color='#FFFF00' >" . "Eff%". "&nbsp;" . "</td>\n</font>
    <td align=center  size='24' font color='#FFFF00' >" . "Hrs". "&nbsp;" . "</td>\n</font>
   <td align=center  size='24' font color='#FFFF00' >" . "Prod ". "&nbsp;" . "</td>\n</font>
   <td align=center  size='24' font color='#FFFF00' >" . "Eff%". "&nbsp;" . "</td>\n</font>
   <td align=center  size='24' font color='#FFFF00' >" . "Hrs". "&nbsp;" . "</td>\n</font>
    <td align=center  size='24' font color='#FFFF00' >" . "Prod ". "&nbsp;" . "</td>\n</font>
      ...
      function initDataTable() {
           ...
           $('#qcrecordTable').DataTable().destroy();
            ...
            table = $('#qcrecordTable').DataTable({
                ajax: {
                    url: '<?php echo base_url('admin/reports/Daily_loom_report/get_dailyloomdata'); ?>',
                    type: 'POST',
                    data: function(d) {
...
$("#attlmreptx").click(function(event){
          ...
          var windingpertoDate = $('#windingpertoDate').val();
             ...
             var remno=1;
             alert (windingperfrDate);
          $.ajax({
            url: "<?php echo base_url('admin/reports/Daily_loom_report/get_dailyloomdata'); ?>",
            type: "POST",
            data: {windingperfrDate: windingperfrDate,windingpertoDate: windingpertoDate,loomtype: loomtype,companyId: companyId,remno: remno
            },
            dataType: "json",
...
function chkDataTable() {
  ...
  table = $('#qcrecordTable').DataTable({
        ...
        $("#exploomdata").click(function(event){
            ...
            var url = '<?php echo site_url("admin/reports/Daily_loom_report/get_dailyloomdataexl"); ?>' +
